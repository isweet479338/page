...
import { addCost, } from '../../../services/actions/BazarAction';
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="user">
                        <div className="form-group">
                         ...
                         <label htmlFor="pp">Expense Section </label>
                            <input type="text"  {...register("cause", { required: true })} placeholder='Expense Section' className="form-control form-control-user" />
                            {errors.cause && <span>This field is required</span>}
                        </div>

                        
                        <div className="form-group">
                         <label htmlFor="pp">Date</label>
                            <input type="date"  {...register("date", { required: true })} placeholder='Expense Amount' className="form-control form-control-user" />
                        ...
                        <div className="form-group">
                         <label htmlFor="pp">Amount</label>
                            <input type="number"  {...register("amount", { required: true })} placeholder='Expense Amount' className="form-control form-control-user" />
                        ...
                        <div className="form-group">
                         <label htmlFor="pp">Set Mill rate</label>
                            ...
                            <textarea placeholder='Add Some Details ' className="form-control form-control-user" {...register("desc")}></textarea>
                        </div>
